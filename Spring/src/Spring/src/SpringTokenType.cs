...
namespace JetBrains.ReSharper.Plugins.Spring
{
    class SpringTokenType : TokenNodeType
    {
        ...
        public static SpringTokenType CONDE = new SpringTokenType("CONDE", 6);
        public static SpringTokenType IDENT = new SpringTokenType("IDENT", 7);
        
        public static SpringTokenType R_ROUND= new SpringTokenType("R_ROUND", 8);
        public static SpringTokenType L_ROUND = new SpringTokenType("L_ROUND", 9);
        public static SpringTokenType R_CURVY= new SpringTokenType("R_CURVY", 10);
        public static SpringTokenType L_CURVY = new SpringTokenType("L_CURVY", 11);
        public static SpringTokenType R_ANGLE= new SpringTokenType("R_ANGLE", 12);
        public static SpringTokenType L_ANGLE = new SpringTokenType("L_ANGLE", 13);

        public static SpringTokenType WS = new SpringTokenType("WS", 14);
        public static SpringTokenType COMMENT = new SpringTokenType("COMMENT", 15);
        public static SpringTokenType BAD_CHARACTER = new SpringTokenType("BAD_CHARACTER", 16);
        
        private static ISet<SpringTokenType> _keywordTokenTypes = new HashSet<SpringTokenType>
        {
            DOUBLE_COLON, COLON, EQ, UNIFICATION, AND, OR, CONDE
        };
